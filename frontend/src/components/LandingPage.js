...
const LandingPage = () => {
  ...
  // --- COMMENTED OUT SPLASH VIDEO STATE ---
  ...
  // --- COMMENTED OUT SPLASH SCREEN RETURN LOGIC ---
  /*
  if (showVideo) {
    return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-100 to-lime-50">
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* Note: Updated path to /login as signup was removed per previous instruction */}
      ...
      <section className="relative h-[90vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          <h1 className="text-4xl md:text-6xl font-bold text-emerald-400 drop-shadow-lg text-center leading-tight">
      ...
      {/* Impact Stats */}
      <section className="py-12 relative -mt-16 z-20 max-w-7xl mx-auto px-4">
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-xl">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg text-center group">
