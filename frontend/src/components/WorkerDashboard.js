...
import {
  ...
  Navigation, Users, Leaf, TrendingUp, Clipboard, XCircle
} from 'lucide-react';
...
const WorkerDashboard = () => {
  ...
  const mockTrainingModules = [
    { 
      title: 'Waste Segregation Techniques', 
      duration: '12 min', 
      completed: true,
      videoId: 'HoeLTqbOJ-k' // Your specific YouTube video
    },
    { 
      title: 'Safe Handling of Hazardous Materials', 
      duration: '18 min', 
      completed: true,
      videoId: 'VWftDJhyNqY' // Safety training video
    },
    { 
      title: 'Route Optimization Best Practices', 
      duration: '15 min', 
      completed: false,
      videoId: 'LBK_5ByJ0nM' // Route optimization
    },
    { 
      title: 'Customer Service Excellence', 
      duration: '22 min', 
      completed: false,
      videoId: 'tNV16tz1NK8' // Customer service training
    }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {mockTrainingModules.map((module, index) => (
                <div key={index} className="card">
                  ...
                  <button 
                    className={`w-full ${module.completed ? 'btn-secondary' : 'btn-primary'}`}
